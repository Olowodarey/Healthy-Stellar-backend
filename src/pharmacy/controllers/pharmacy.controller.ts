...
export class PharmacyController {
  @Post('drugs')
  @ApiOperation({ summary: 'Add drug to inventory', description: 'Add new medication to pharmacy inventory with NDC tracking' })
  ...
  @Get('drugs')
  @ApiOperation({ summary: 'Get drug inventory', description: 'Retrieve pharmacy inventory with stock levels' })
  ...
  @Get('drugs/:id')
  @ApiOperation({ summary: 'Get drug details', description: 'Retrieve complete drug information including interactions' })
  ...
  @Put('drugs/:id/stock')
  @ApiOperation({ summary: 'Update drug stock', description: 'Adjust inventory levels for medication' })
  ...
  @Post('prescriptions')
  @ApiOperation({ summary: 'Create prescription', description: 'Create new prescription order with safety checks' })
  ...
  @ApiOperation({ summary: 'Fill prescription', description: 'Process prescription filling with verification' })
  ...
  @ApiOperation({ summary: 'Verify prescription', description: 'Pharmacist verification before dispensing' })
  ...
  @ApiOperation({ summary: 'Get patient prescriptions', description: 'Retrieve all prescriptions for a patient' })
  ...
  @Post('safety-check')
  @ApiOperation({ summary: 'Check drug interactions', description: 'Verify drug interactions and contraindications' })
  @ApiResponse({ status: 200, description: 'Safety check completed', schema: {
  ...
  @ApiOperation({ summary: 'Get expiring medications', description: 'List medications nearing expiration' })
